...
The problem is to carry out an Event Detection task, detecting which words in a sentence represent the event trigger, and what type of event they indicate.
...
Three JSONL files, `train.jsonl`, `dev.jsonl` and `test.jsonl` which contain respectively 20,000, 2,000 and 2,000 sentences.
